...
def analiz_et(symbol):
    ...
    return {
        "symbol": symbol,
        "fiyat": round(guncel_fiyat, 4),
        "degisim": round(degisim, 4),
        "trend_3m": trend_3m,
        "hma13": round(hma13_1m[-1], 4),
        "hma30": round(hma30_1m[-1], 4),
        "sinyal": nihai_sinyal,
        "sinyal_guc": sinyal_guc,
        "zaman": datetime.now().strftime('%H:%M:%S'),
        "grafik": kapanis_1m[-20:],
        "hma13_grafik": hma13_1m[-20:],
        "hma30_grafik": hma30_1m[-20:],
    }
